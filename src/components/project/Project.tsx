        ...
        <div className='mt-12 grid gap-10 lg:grid-cols-3 md:grid-cols-2 '>
          {projectData.slice(0, 6).map((item: projectProps) => (
            ...
            >
              ...
              <h1 className='group-hover:text-white border border-[#1F618D]/70 shadow-2xl text-base  md:text-xl font-thin text-left capitalize text-black group-hover:bg-[#1F618D]/70 rounded-lg darkk:text-white mt-4 items-center flex justify-between  w-full py-2 px-4 duration-700'>
                {item.title}
