...
const Header = () => {
  ...
  return (
    <div
      className={`${scroll} h-20 sticky top-0 left-0  color dark:text-white color flex justify-between items-center z-40 transition bgsticky px-1 md:px-7`}
    >
      <div
        className={` main-container  flex justify-between items-center  w-full`}
      >
        <Link href="/">
