      ...
      <div className='text-center'>
        ...
        <div className='mt-12  max-w-2xl mx-auto'>
          ...
          <Link href='/contact'>
            <button
              data-aos='fade-up'
              className='cursor-pointer uppercase mt-5 hover:text-black hover:bg-white text-white  bg-[#1F618D] px-4 py-2 active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#F44336,-0.5rem_-0.5rem_#00BCD4] transition'
            >
              contact me
            </button>
          </Link>
